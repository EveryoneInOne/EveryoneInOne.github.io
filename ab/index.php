...
<body>
	...
	<form action="query_insert.php" method="post" id="startForm">
		...
		<br/>Pierwsza zmienna(opisowa)<br/>
		<input type="text" value="Znacznik" name="formularz_zmienna_1"/>
		<br/>Druga zmienna(numeryczna)<br/>
		<input type="text" name="formularz_zmienna_2" value="10"/>
		<br/>Szerokość Geograficzna <br/>
		<input type="text" name="zmienna_formularz_SZER" value='51.2'>
		<br/> Długość Geograficzna<br/>
		<input type="text" name="zmienna_formularz_DL" value='21.4'><br/><br/>
