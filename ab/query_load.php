...
$result = pg_query("SELECT id, pierwsza_zmienna_opisowa, druga_zmienna_numeryczna, ST_AsGeoJSON (geometria, 5) as geometria FROM public.tabela_lab ORDER BY ID ASC ");
